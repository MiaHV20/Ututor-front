          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              <select
                ...
                className="w-full px-4 py-4 border border-gray-300 bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-200 transition-all rounded-md"
                required
              >
